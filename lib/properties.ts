...
// ─────────────────────────────────────────────────────────────────────────────
// ONNAN UNITY — PROPERTY DATA
// This is the single source of truth for all property data.
// To add a new property: copy an existing entry, update all fields,
// add images to /public/images/properties/[slug]/, set isFeatured if needed.
// ─────────────────────────────────────────────────────────────────────────────
...
export const properties: Property[] = [
  {
    ...
    description:
      ...
      "Situated in the heart of Maitama, residents enjoy immediate proximity to diplomatic " +
      "missions, fine dining, and Abuja's central business district.",
    location:     "Askia Road, Maitama, Abuja",
    ...
    features: [
      { icon: "Zap",         title: "Solar Power",    description: "24/7 backup solar grid ensuring uninterrupted power." },
      { icon: "ShieldCheck", title: "Smart Security", description: "CCTV surveillance and 24-hour security personnel." },
      { icon: "Waves",       title: "Smart Home",     description: "Pre-wired for home automation and high-speed fibre." },
      { icon: "Trees",       title: "Green Spaces",   description: "Landscaped gardens and outdoor leisure areas." },
    ],
    proximity: [
...

  {
    ...
    description:
      "Building on the success of Askia I, Askia II raises the benchmark with larger floor plans, " +
      "upgraded specifications, and an expanded suite of estate amenities. Each home is crafted " +
    ...
    location:     "46 Askia Avenue, Maitama, Abuja",
    neighborhood: "Maitama",
    type:         "Villa",
    status:       "For Sale",
    priceFrom:    220000000,
    ...
    features: [
      { icon: "Zap",         title: "Solar Power",    description: "Dedicated solar installation with battery backup." },
      { icon: "ShieldCheck", title: "AI Security",    description: "Facial recognition entry and ANPR gate system." },
      { icon: "Wifi",        title: "FTTH Internet",  description: "Fibre-to-the-home broadband infrastructure." },
      { icon: "Car",         title: "Parking",        description: "Covered double garage per unit." },
    ],
    proximity: [
      { label: "To CBD",       value: "8 mins"  },
      { label: "To Airport",   value: "30 mins" },
...

  {
    ...
    features: [
      { icon: "Zap",          title: "Solar Grid",    description: "Full estate solar power with generator backup." },
      { icon: "ShieldCheck",  title: "24/7 Security", description: "Round-the-clock manned security and CCTV." },
      { icon: "Droplets",     title: "Swimming Pool", description: "Private infinity-edge pool per unit." },
      { icon: "Dumbbell",     title: "Gym",           description: "Fully equipped private gymnasium." },
    ],
    proximity: [
...

  {
    ...
    features: [
      { icon: "Zap",         title: "Solar Power",   description: "Sustainable energy powering the entire community." },
      { icon: "ShieldCheck", title: "Gated Access",  description: "Perimeter fencing with manned entry gates." },
      { icon: "Trees",       title: "Landscaping",   description: "Professionally landscaped communal gardens." },
      { icon: "Droplets",    title: "Water Supply",  description: "Borehole and treated water supply." },
    ],
    proximity: [
...

  {
    ...
    features: [
      { icon: "Zap",         title: "Solar Backup",  description: "Solar inverter system for uninterrupted power." },
      { icon: "ShieldCheck", title: "Security",      description: "24-hour security with CCTV coverage." },
      { icon: "Car",         title: "Parking",       description: "Private driveway and covered parking." },
      { icon: "Wifi",        title: "Connectivity",  description: "High-speed broadband infrastructure." },
    ],
    proximity: [
...

  {
    ...
    features: [
      { icon: "Zap",         title: "Power Backup",  description: "Solar-assisted generator backup system." },
      { icon: "ShieldCheck", title: "Security",      description: "Gated estate with 24-hour manned security." },
      { icon: "Trees",       title: "Green Spaces",  description: "Landscaped private gardens per unit." },
      { icon: "Droplets",    title: "Water",         description: "Dedicated borehole and treatment plant." },
    ],
    proximity: [
...

  {
    ...
    features: [
      { icon: "Zap",         title: "Solar Power",    description: "Rooftop solar panels with battery storage." },
      { icon: "ShieldCheck", title: "Security",       description: "Perimeter fencing, CCTV and security booth." },
      { icon: "Car",         title: "Parking",        description: "Allocated parking bays per unit." },
      { icon: "Wifi",        title: "Smart-Ready",    description: "Pre-wired for smart home and fibre internet." },
    ],
    proximity: [
...
/** Return only featured properties (for homepage) */
...
/** Return all slugs — used for generateStaticParams in [slug]/page.tsx */
export function getPropertySlugs(): string[] {
  return properties.map((p) => p.slug);
}

/** Return properties filtered by neighborhood */
