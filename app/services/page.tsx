...
export const metadata: Metadata = {
  title: "Services",
  description:
    "Onnan Unity offers real estate development, civil construction, and solar power solutions across Abuja.",
};
...
const whyUs = [
  {
    ...
    detail:
      "We manage every stage of the project lifecycle, from initial concept through to resident handover.",
  },
  {
    title: "In-House Expertise",
    detail:
      "Our architecture, engineering, and solar teams work under one roof, eliminating costly coordination delays.",
  },
  {
    title: "Sustainable by Design",
    detail:
      "Solar infrastructure and energy-efficient systems are built into every project from the foundation up.",
  },
  {
    title: "Transparent Pricing",
    detail:
      "No hidden costs. We agree a clear specification and budget at the outset and hold to it.",
  },
];
              ...
              <div className="flex flex-col gap-7">
                ...
                <ul className="grid grid-cols-2 gap-3">
                  {service.features.map((f) => (
                    <li
                      key={f}
                      className="flex items-center gap-2 font-sans text-xs text-luxury-muted"
                    >
                      <CheckCircle
                        size={12}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-white/5">
          {whyUs.map(({ title, detail }, i) => (
            ...
            >
              ...
              <h3 className="font-sans text-sm font-medium text-luxury-cream">
                {title}
              </h3>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 border border-luxury-gold/15 p-12 relative">
          ...
          <div className="flex flex-col gap-3 max-w-lg">
            ...
            <p className="font-sans text-sm text-luxury-muted">
              Whether you&apos;re acquiring land, commissioning a build, or
              exploring an estate purchase — our team is ready to talk.
            </p>
          </div>
