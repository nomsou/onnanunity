...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Get in touch with Onnan Unity. Request a site visit, speak with an agent, or send us a message.",
};
                  ...
                  <div>
                    ...
                    {lines.map((line, i) =>
                      href && i === 0 ? (
                        ...
                        <p
                          key={i}
                          className="font-sans text-sm text-luxury-muted"
                        >
                          {line}
                        </p>
                      ),
          ...
          {[
            {
              ...
              detail:
                "Speak to an agent about pricing, availability, and payment plans for any of our estates.",
            ...
            },
            {
              ...
              detail:
                "Schedule a guided tour of any of our developments at a time that suits you.",
              cta: "Request Visit",
              href: "https://www.instagram.com/onnanunityco",
            },
            {
              title: "Construction Enquiry",
              detail:
                "Discuss a civil construction or solar installation project with our technical team.",
              cta: "View Services",
              href: "/services",
            },
            ...
            <div
              key={title}
              className="bg-luxury-charcoal p-10 flex flex-col gap-4 group hover:bg-luxury-charcoal2 transition-colors duration-300"
            >
              ...
              <p className="font-sans text-xs text-luxury-muted leading-relaxed flex-1">
                {detail}
              </p>
              <a
                href={href}
